...
\title{ECE 382V: Introduction to Quantum Computing Systems from a Software and Architecture Perspective\\Homework 1}
\author{Sayam Sethi}
\date{September 2023}
...
\section{Question 2}
\begin{solution}{System Calibrations}\label{ques:2}
        \input{2}
\end{solution}

\section{Question 3}
\begin{solution}{Compilation: Qubit Mapping and Routing}\label{ques:3}
        \input{3}
\end{solution}

\section{Question 4}
\begin{solution}{Pulse Compilation}\label{ques:4}
        \input{4}
\end{solution}
