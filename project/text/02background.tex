...
\begin{figure*}
    ...
    \begin{subfigure}{0.24\textwidth}
        \centering
        \includesvg[width=0.9\linewidth]{figs/regular_star.svg}
    \end{subfigure}
    \begin{subfigure}{0.24\textwidth}
        \centering
        \includesvg[width=0.9\linewidth]{figs/compact_star.svg}
    \end{subfigure}
    \begin{subfigure}{0.24\textwidth}
        \centering
        \includesvg[width=0.9\linewidth]{figs/compressed_star.svg}
    \end{subfigure}
    \begin{subfigure}{0.24\textwidth}
        \centering
        \includesvg[width=0.9\linewidth]{figs/mixed_grid.svg}
    \end{subfigure}
...
\begin{figure}
    \centering
    \includesvg[width=0.6\columnwidth]{figs/parallel_prepare.svg}
